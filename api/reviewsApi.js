...
export default {
  ...
  async getReviewsForUs(organization_id, params = {}) {
    return axios.get(`organization/${organization_id}/reviews/about`, {params});
  },
  ...
  async addAdditionsReview(value, form) {
    return useApi().post(`reviews/${value.id}/additions`, {user_id: value.user_id, text: value.text}, form);
  },
