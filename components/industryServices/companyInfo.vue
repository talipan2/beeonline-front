<template>
  <div class="company-info">
    <div class="company-info__header">
      <h3 class="company-info__title title-hidden">Национальный центр сертификации</h3>
    ...
    <div class="company-info__content">
      <div class="image-box company-info__logo">
        <img :src="data.logo || defaultCompanyLogo" :alt="data.name">
      </div>
      <div class="company-info__wrapper company-info__mobile">
        <CommonLocationsList class="company-info__locations" :locationsList="data.countryId"/>
        <h4 class="company-info__site">
          Сайт:
          <a :href="data.siteUrl" class="link link_type_hidden" target="_blank">{{ data.siteUrl }}</a>
        </h4>
      </div>
      <div class="company-info__wrapper">
        <CommonLocationsList class="company-info__locations company-info__desktop" :locationsList="data.countryId"/>
        <h4 class="company-info__site company-info__desktop">
          Сайт:
          <a :href="data.siteUrl" class="link" target="_blank">{{ data.siteUrl }}</a>
        </h4>
        <div class="company-info__description">
          <h4>Описание:</h4>
          <p class="company-info__description-text" :class="{'company-info__description-text_type_hidden' : !isVisible}">{{ data.description }}</p>
        </div>
        <div class="company-info__gallery" v-if="isVisible">
          <h4>Галерея:</h4>
