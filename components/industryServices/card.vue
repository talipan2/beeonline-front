<template>
    <div
        class="industry-services-card"
        :class="{ 'industry-services-card_type_hover': !isChange }"
    >
        <h2 class="industry-services-card__title">
            ...
            <div class="industry-services-card__wrapper">
                <div class="props">
                    ...
                    <div class="prop prop_type_text">
                        ...
                        <p class="prop__value prop_type_hidden">
                            {{ data.description }}
                        </p>
                    </div>
                </div>
        ...
        <template v-if="!isPreview">
            <div
                class="industry-services-card__buttons"
                v-if="!isChange"
            >
                <UiButton
                    class="industry-services-card__btn"
                    variant="tertiary"
                    size="large"
                    :to="{
                        path: '/chat',
                        query: { adjacent_service_id: data.id },
                    }"
                    >Написать</UiButton
                >
                <UiButton
                    :to="`/related-industry-services/${data.pubcard.id}/${data.id}`"
                    class="industry-services-card__btn"
                    variant="quinary"
                    size="large"
                    >Подробнее</UiButton
            ...
            <div
                class="industry-services-card__buttons industry-services-card__buttons_type_edit"
                v-else
            >
                <UiButton
                ...
                <IndustryServicesActionToArchive
            ...
            <NuxtLink
                class="industry-services-card__link"
                :to="`/related-industry-services/${data.pubcard.id}/${data.id}`"
            />
        </template>
    </div>
