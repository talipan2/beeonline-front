<template>
  ...
  const stages = [
    ...
    },
    {
      ...
      title: "Начало работы",
      description:
        "Заказчик или производитель инициируют сделку, определяя основные условия и параметры.",
    },
    {
      code: "ts_agree",
    ...
    },
    {
      ...
      title: "Производство",
      description:
        "Производитель начинает выполнение заказа в соответствии с согласованными условиями и ТЗ.",
    },
    {
      code: "delivery",
      title: "Доставка",
    ...
    },
    {
      ...
      description:
        "После успешной проверки средства перечисляются производителю, завершая финансовую часть сделки.",
    },
  ];
