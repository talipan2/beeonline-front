	...
	>
      ...
      /> -->
			...
			<div class="org-check__list">
				<div
					class="org-check__item"
					v-for="(org, index) in counterpartyCheckList"
					:key="index"
				>
					<p class="org-check__col org-check__col_type_one">
						{{ formatDate(org.created_at, 'DD.MM.YYYY - mm:HH') }}
					</p>
					<p class="org-check__col org-check__col_type_two">
						{{ org.counterparty_name }}
					</p>
					<p class="org-check__col org-check__col_type_three">
						{{ formatStatus(org.status) }}
					</p>
					<div
						class="org-check__col org-check__btn-container"
						v-if="org.file"
					>
						<PaidServiceCounterpartyCheck :id="org?.counterparty_id">
							<template #button="{ open }">
								<UiButton
									type="button"
									class="org-check__btn org-check__btn_type_one"
									variant="tertiary"
									size="large"
									@click="open"
								>
						...
						<a
							class="btn btn-quinary btn-large org-check__btn"
							:href="org.file?.url"
							download
						>
							<SvgoDownload
