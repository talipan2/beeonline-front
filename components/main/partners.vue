<template>
  <section class="partners">
    <div class="partners__details container">
      <div class="partners__text-container">
        ...
        <ul class="partners__list">
          ...
          <li class="partners__item">
            ...
            <UiImage src="/assets/images/main/partners/partners-notifications.png" />
          </li>
          <li class="partners__item">
      ...
      <UiImage class="partners__image" src="/assets/images/main/partners/partners-img.png" />
      <UiImage class="partners__pattern" src="/assets/images/main/partners/partners-pattern.png" />
      <UiImage class="partners__pattern-mobile" src="/assets/images/main/partners/partners-pattern-mobile.png" />
    </div>
  </section>
</template>
...
<style lang="scss">
.partners {
    background-image: url(/assets/images/main/partners/partners-bg.png);
