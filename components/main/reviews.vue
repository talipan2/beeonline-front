...
<script setup>
	...
	const data = ref([
		...
		},
		{
			...
			text: `"Это 100% отраслевая платформа — разработана профессионалами легпрома для профессионалов. Работа ведется в ключе конструктивного диалога, за что спасибо команде BEE-online.ru."`,
		},
	]);
