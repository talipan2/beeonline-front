    ...
    <div class="services__container">
      <div class="services__card services__card_type_performers">
        ...
        <p class="services__description">
          ...
          На платформе доступен поиск швейных фабрик и цехов для пошива одежды, и возможность установить прямые контакты для контрактного производства без посредников.
        </p>
      ...
      <div class="services__card services__card_type_customers">
        ...
        <p class="services__description">
          Расширьте свой бизнес и увеличьте объём заказов — найдите новых клиентов среди ведущих брендов и ритейлеров с нашим удобным и быстрым сервисом!
...
.services__card_type_performers {
  background-color: #9367c4
}
