  ...
  <template v-for="tariff in tariffs" :key="tariff">
    <TariffsCardLayout class="international-tariffs" v-for="price in tariff.prices" :key="price">
      <div class="international-tariffs__body">
        ...
        <UiButton v-if="tariffsStore.tariffName !== 'Международный'" type="button" class="international-tariffs__btn" variant="quinary" size="large" @click="handleOpenSupportModal">Подключить</UiButton>
      </div>
