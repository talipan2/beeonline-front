<template>
  <div class="nameplate">
    <div class="nameplate__name">
      ...
      <svg v-if="type === 'tariff'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg v-if="type === 'contacts'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
